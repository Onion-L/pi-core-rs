//! Port of `pi-core/ai/src/auth/oauth/oauth-page.ts`: the OAuth callback
//! pages served by loopback callback servers.
...
mod tests {
    ...
    #[test]
    fn omits_the_details_block_when_absent() {
        let page = oauth_success_html("Signed in.");
